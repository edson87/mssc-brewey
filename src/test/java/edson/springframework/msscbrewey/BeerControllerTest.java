...
import edson.springframework.msscbrewey.controller.BeerController;
...
public class BeerControllerTest {
    ...
    public void handlePost() throws Exception {
        ...
        BeerDto saveDto = BeerDto.builder().id(UUID.randomUUID()).beerName("Taquiña").beerStyle("Black").upc(789456123L).build();
